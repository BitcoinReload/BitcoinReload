...
libs = [
    'libbitcoinreload_cli',
    'libbitcoinreload_common',
    'libbitcoinreload_crypto',
    'libbitcoinreload_server',
    'libbitcoinreload_util',
    'libbitcoinreload_wallet_tool',
    'libbitcoinreload_wallet',
    'libbitcoinreload_zmq',
    'bench_bitcoinreload',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='BitcoinReload-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinreload_config.h'), os.path.join(SOURCE_DIR, 'config/bitcoinreload-config.h'))
