...
// bitcoinreload includes.
#include <..\src\script\bitcoinreloadconsensus.h>
...
int main()
{
    std::cout << "bitcoinreloadconsensus version: " << bitcoinreloadconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoinreloadconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitcoinreloadconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
