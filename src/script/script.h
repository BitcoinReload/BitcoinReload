...
#ifndef BITCOINRELOAD_SCRIPT_SCRIPT_H
#define BITCOINRELOAD_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinReload always counted CHECKMULTISIGs
...
#endif // BITCOINRELOAD_SCRIPT_SCRIPT_H
