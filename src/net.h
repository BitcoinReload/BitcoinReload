...
#ifndef BITCOINRELOAD_NET_H
#define BITCOINRELOAD_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitcoinReload’s Peer-to-Peer Network")
