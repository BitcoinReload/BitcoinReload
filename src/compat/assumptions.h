...
#ifndef BITCOINRELOAD_COMPAT_ASSUMPTIONS_H
#define BITCOINRELOAD_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinReload cannot be compiled without assertions."
#endif
...
#endif // BITCOINRELOAD_COMPAT_ASSUMPTIONS_H
