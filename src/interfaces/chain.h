...
#ifndef BITCOINRELOAD_INTERFACES_CHAIN_H
#define BITCOINRELOAD_INTERFACES_CHAIN_H
...
//! internal workings of the bitcoinreload node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/bitcoinreload/bitcoinreload/pull/15288#discussion_r253321096).
//!
...
#endif // BITCOINRELOAD_INTERFACES_CHAIN_H
