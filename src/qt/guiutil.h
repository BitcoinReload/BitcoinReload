...
#ifndef BITCOINRELOAD_QT_GUIUTIL_H
#define BITCOINRELOAD_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinReload Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinreload:" URI into recipient object, return true on successful parsing
...
#endif // BITCOINRELOAD_QT_GUIUTIL_H
