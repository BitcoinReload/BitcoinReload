...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BitcoinReloadGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BitcoinReloadGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BitcoinReloadGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BitcoinReloadGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BitcoinReloadGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BitcoinReloadGUI::updateWalletStatus);
    connect(gui, &BitcoinReloadGUI::setPrivacy, walletView, &WalletView::setPrivacy);
