...
#ifndef BITCOINRELOAD_QT_SENDCOINSDIALOG_H
#define BITCOINRELOAD_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinreloads */
...
#endif // BITCOINRELOAD_QT_SENDCOINSDIALOG_H
