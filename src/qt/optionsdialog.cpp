    ...
    mapper(nullptr)
{
    ...
    ui->bitcoinreloadAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinreloadAtStartup);
    ...
    ui->bitcoinreloadAtStartup->setToolTip(ui->bitcoinreloadAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinreloadAtStartup->setText(ui->bitcoinreloadAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinReloadConfButton->setToolTip(ui->openBitcoinReloadConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinReloadUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinreloadAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinReloadConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinReloadConf())
