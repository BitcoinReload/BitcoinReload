...
#ifndef BITCOINRELOAD_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINRELOAD_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinreload.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinreload combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinreload cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinreload are relatively fast in
...
#endif // BITCOINRELOAD_CRYPTO_CHACHA_POLY_AEAD_H
