...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinreloadcore.org", "www.bitcoinreloadcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreloadcore.org]", "www.bitcoinreloadcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinreloadcore.org:80", "www.bitcoinreloadcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinreloadcore.org]:80", "www.bitcoinreloadcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4662", "127.0.0.1", 4662));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4662", "127.0.0.1", 4662));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4662", "::ffff:127.0.0.1", 4662));
    BOOST_CHECK(TestSplitHost("[::]:4662", "::", 4662));
    BOOST_CHECK(TestSplitHost("::4662", "::4662", -1));
    BOOST_CHECK(TestSplitHost(":4662", "", 4662));
    BOOST_CHECK(TestSplitHost("[]:4662", "", 4662));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4662", "127.0.0.1:4662"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4662", "[::]:4662"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
