...
#ifndef BITCOINRELOAD_TEST_SCRIPTNUM10_H
#define BITCOINRELOAD_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinReload Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRELOAD_TEST_BIGNUM_H
