...
#ifndef BITCOINRELOAD_WALLET_WALLETUTIL_H
#define BITCOINRELOAD_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinreload from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINRELOAD_WALLET_WALLETUTIL_H
