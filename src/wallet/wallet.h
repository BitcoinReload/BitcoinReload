...
#ifndef BITCOINRELOAD_WALLET_WALLET_H
#define BITCOINRELOAD_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinreload node, and set to 0 for transactions that were created
...
#endif // BITCOINRELOAD_WALLET_WALLET_H
