...
#ifndef BITCOINRELOAD_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINRELOAD_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The BitcoinReload Core wallet was originally a collection of unrelated private
...
#endif // BITCOINRELOAD_WALLET_SCRIPTPUBKEYMAN_H
