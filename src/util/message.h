...
#ifndef BITCOINRELOAD_UTIL_MESSAGE_H
#define BITCOINRELOAD_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinreload address, it must refer to a public key.
...
#endif // BITCOINRELOAD_UTIL_MESSAGE_H
