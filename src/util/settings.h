...
#ifndef BITCOINRELOAD_UTIL_SETTINGS_H
#define BITCOINRELOAD_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoinreload/bitcoinreload/pull/15934/files#r337691812)
...
#endif // BITCOINRELOAD_UTIL_SETTINGS_H
