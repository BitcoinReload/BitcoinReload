...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/BitcoinReload
else
  DOCKER_EXEC echo \> \$HOME/.bitcoinreload
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bitcoinreload/bitcoinreload/pull/18288#discussion_r433189350 for
  # details.
