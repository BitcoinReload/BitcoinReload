...
class TestShell:
    """Wrapper Class for BitcoinReloadTestFramework.

    The TestShell class extends the BitcoinReloadTestFramework
    ...
    class __TestShell(BitcoinReloadTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinReloadTestFramework child class.
            self.num_nodes = 1
