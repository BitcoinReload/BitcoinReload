...
By default, bitcoinreloadd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinReloadTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinreloadd from writing mempool.dat to disk. Verify that `savemempool` fails")
