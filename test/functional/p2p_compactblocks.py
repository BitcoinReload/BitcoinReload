...
# TestP2PConn: A peer we use to send messages to bitcoinreloadd, and store responses.
...
class CompactBlocksTest(BitcoinReloadTestFramework):
    ...
    # This test actually causes bitcoinreloadd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinreloadd's choice of nonce.
    ...
    # Test that bitcoinreloadd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinreloadd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitcoinreloadd will not send blocktxn responses for blocks whose height is
