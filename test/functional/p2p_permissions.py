...
class P2PPermissionsTests(BitcoinReloadTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitcoinreloadconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bitcoinreloadconf, 'w', encoding="utf8") as f:
            f.write(newText)
