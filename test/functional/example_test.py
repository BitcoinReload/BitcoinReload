...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinReloadTestFramework
    pass


class ExampleTest(BitcoinReloadTestFramework):
    # Each functional test is a subclass of the BitcoinReloadTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinReloadTestFramework class so other tests can use it."""
