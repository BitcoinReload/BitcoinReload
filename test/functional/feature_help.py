...
"""Verify that starting bitcoinreload with -h works as expected."""

from test_framework.test_framework import BitcoinReloadTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinReloadTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinreload with -h for help text")
        ...
        self.log.info("Start bitcoinreload with -version for version information")
        ...
        self.log.info("Start bitcoinreloadd with -fakearg to make sure it does not start")
