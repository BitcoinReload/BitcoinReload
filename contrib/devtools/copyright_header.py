...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinreloadstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The BitcoinReload Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a bitcoinreload source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinReload Core developers'
...
Arguments:
    <file> - A source file in the bitcoinreload repository.
"""
