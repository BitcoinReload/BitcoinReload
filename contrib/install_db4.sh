...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoinreload repository."
  exit 1
fi
...
# See https://github.com/bitcoinreload/bitcoinreload/issues/16064
...
echo 'When compiling bitcoinreloadd, run `./configure` in the following way:'
echo
