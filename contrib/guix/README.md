# Bootstrappable BitcoinReload Core Builds

This directory contains the files necessary to perform bootstrappable BitcoinReload
Core builds.
...
- 24GB of free disk space on the partition that the BitcoinReload Core git repository
  resides in
...
For a BitcoinReload Core depends development environment, simply invoke
...
From the top of a clean BitcoinReload Core repository:
...
To use dongcarl's substitute server for BitcoinReload Core builds after having
