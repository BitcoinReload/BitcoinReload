...
This document provides guidelines for internationalization of the BitcoinReload Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinreload_en.ts` remains unchanged.
